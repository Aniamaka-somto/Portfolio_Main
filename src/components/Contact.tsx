const Contact = () => {
  const social = [
    {
      href: "https://www.github.com/Aniamaka-somto",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col reveal-up">
          <h2 className="headline-2 lg:max-w-[12ch]">Let's Create Something</h2>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {social.map(({ icon, href }, index) => (
              <a
                key={index}
                href={href}
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-full transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/bwnndzpa"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="somtoaniams@gmail.com"
              />
            </div>
          </div>
